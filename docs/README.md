...
- `scripts/deploy-scaling.sh` - Déploiement HPA/PDB
- `scripts/test-hpa.sh` - Test autoscaling
- `scripts/test-pdb.sh` - Test disruption budget
...
- `docs/SLO-SLI.md` - Définition SLO/SLI et résultats
